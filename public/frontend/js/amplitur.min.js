...
(function () {
    ...
    // serviços principais
    var $servicosPrincipaisAll = $('.servico-divide');
    var $servicoSoldOutbtn = $(".servico-principal__sold_out");
    ...
    $servicosPrincipaisAbrir.click(function(){
        $(this).fadeOut("fast");
        $(".servico-principal-data .servico-divide").show();
        $servicosPrincipaisAll.removeClass('ativo');
        removerAdicionais();
    ...
    //servico click sold out button
    $servicoSoldOutbtn.on('click', function(e) { 
        var check_sold = $(this).hasClass("sold_out");
        if(!check_sold) {
            $(this).addClass('sold_out');
            var $input = $(this).closest('.servico-divide').find('input');
            $input.prop('checked', true);
            var id          = $(this).closest('.servico-divide').find('.servico-principal').attr('id');
            var valor       = $input.val();
            ...
            $(this).closest('.servico-divide').addClass('ativo');
            $servicosPrincipais.not('#' + id).each(function() {
                $( this ).closest('.servico-divide').fadeOut('fast');
            });
            ...
            $(".passo__servicos-principais-abrir").hide();
            $(".servico-principal-data .servico-divide").show();
            $servicosPrincipaisAll.removeClass('ativo');
            removerAdicionais();
    ...
    function doServicoPrincipais(){
        ...
        //scrollTo($contServicoPrincipal); 
        $soldbtn = $(this).closest('.servico-divide').find('.servico-principal__sold_out');
        var check_sold = $soldbtn.hasClass("sold_out");
        if (check_sold) {
            $soldbtn.removeClass('sold_out');
        } else {
            $soldbtn.addClass('sold_out');
        }
    }
