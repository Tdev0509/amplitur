...
class BookingBill extends Model
{
    ...
    public function getDescription()
    {
        ...
        return __('resources.booking-bills.model.installment') . ' ' . $this->installment . ': ' . $this->paymentMethod->name . ' – ' . $this->currency->code . ' ' . $this->getTotalLabel() . ' – ' . __('messages.expiring');
    }
}
